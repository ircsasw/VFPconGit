...
** Error Messages
**************************************************************************
#DEFINE NO_DATABASE_IN_USE_LOC	"No hay ninguna base de datos en uso. " +"Este programa debe tener una base de datos " +								"disponible."


#DEFINE INVALID_PARAMETERS_LOC	"Los par·metros no son v·lidos..." + CRLF +"Se debe especificar un archivo de salida." + CRLF +								'Por ejemplo: DO GENDBC WITH "archivo.prg"'


#DEFINE INVALID_DESTINATION_LOC	"El archivo de destino no es v·lido "
#DEFINE NO_TEMP_FILE_LOC		"No se pudo crear el archivo temporal: "
#DEFINE NO_OUTPUT_WRITTEN_LOC   "No se pudo crear o escribir en el archivo de salida"
#DEFINE ERROR_TITLE_LOC			"Anulando GenDBC..."
#DEFINE UNRECOVERABLE_LOC		"Error irrecuperable: "
#DEFINE AT_LINE_LOC				" En la lÌnea: "
#DEFINE NO_FIND_LOC				"No se pudo establecer informaciÛn de IR."
#DEFINE NO_FILE_FOUND_LOC		"°Advertencia! No se ha encontrado ning˙n archivo de procedimientos."
#DEFINE GETFILE_GEN_LOC			"Generar..."
#DEFINE NOT_SUPPORTED_LOC		"En este momento no se permiten los filtros en las claves PRIMARY. " +"Se agregar· un comentario a su archivo de salida especificando los filtros."

#DEFINE NS_COMMENT_LOC			"****** Estos filtros deben agregarse manualmente ******"
#DEFINE WARNING_TITLE_LOC		"Aviso de GenDBC..."

**************************************************************************
** Comments And Other Information
**************************************************************************
#DEFINE MESSAGE_START_LOC	"Creando base de datos..."
#DEFINE MESSAGE_DONE_LOC	"Terminado."
#DEFINE MESSAGE_MAKETABLE_LOC 	"Creando tabla "
#DEFINE MESSAGE_MAKEVIEW_LOC	"Creando vista "
#DEFINE MESSAGE_MAKECONN_LOC	"Creando conexiÛn "
#DEFINE MESSAGE_MAKERELATION_LOC	"Creando relaciones persistentes..."
#DEFINE MESSAGE_MAKERI_LOC	"Creando reglas de integridad referencial..."
#DEFINE MESSAGE_END_LOC		"..."
#DEFINE BEGIN_RELATION_LOC		"*************** Inicio del establecimiento de relaciones **************"
#DEFINE BEGIN_TABLE_LOC			"ConfiguraciÛn de tabla para "
#DEFINE BEGIN_INDEX_LOC			"Crear cada Ìndice para "
#DEFINE BEGIN_PROP_LOC			"Cambiar propiedades para "
#DEFINE BEGIN_VIEW_LOC			"Ver la configuraciÛn para "
#DEFINE BEGIN_PROC_LOC			"Volver a crear el procedimiento"
#DEFINE BEGIN_CONNECTIONS_LOC	"Definiciones de conexiones"
#DEFINE BEGIN_RI_LOC			"ConfiguraciÛn de integridad referencial"
#DEFINE OPEN_DATABASE_LOC		"Base de datos..."
#DEFINE SAVE_PRG_NAME_LOC		"Programa de salida..."
#DEFINE NO_MODIFY_LOC			"*** ADVERTENCIA *** °NO MODIFIQUE ESTE ARCHIVO DE NINGUNA FORMA! *** ADVERTENCIA ***"
#DEFINE TABLE_NAME_LOC			"*     Nombre de tabla: "
#DEFINE PRIMARY_KEY_LOC			"*      Clave principal: "
#DEFINE FILTER_EXP_LOC			"* ExpresiÛn de filtro: "
#DEFINE HEADING_1_LOC	"* *********************************************************" + CRLF +"* *" + CRLF

#DEFINE HEADING_2_LOC	"* *" + CRLF +"* *********************************************************" + CRLF +						"* *" + CRLF +						"* * DescripciÛn:" + CRLF +						"* * Este programa lo ha generado autom·ticamente GENDBC" + CRLF +						"* * VersiÛn 2.26.67" + CRLF +						"* *" + CRLF +						"* *********************************************************" + CRLF
